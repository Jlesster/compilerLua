...
M.options = {
  ...
  { text = "", value = "separator"},
  { text = "Build and run with Maven", value = "option10" },
  { text = "Build with Maven", value = "option11" },
  { text = "Run with Maven", value = "option12" }
}
...
function M.action(selected_option)
  ...
  -- Get the main class from pom.xml, safely
  local main_class = get_main_class()
  if not main_class or main_class == "" then
    main_class = "com.jless.chess.App"  -- fallback default
  end
 ...
 --=========================== Maven support ============================--
if selected_option == "option10" then -- Build & run with Maven
